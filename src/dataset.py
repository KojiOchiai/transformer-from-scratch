...
class TranslationDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        # Dubble chedk the size of the tensors to make sure they are all seq long
